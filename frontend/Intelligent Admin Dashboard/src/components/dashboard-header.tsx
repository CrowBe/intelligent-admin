      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl text-slate-900 dark:text-white">Intelligent Admin</h1>
              <p className="text-sm text-slate-600 dark:text-slate-300">{businessName}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-100 dark:bg-green-900/30">
            ...
            <span className="text-sm text-green-700 dark:text-green-400">AI Active</span>
          </div>
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-slate-200 dark:border-slate-700">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">Business Owner</p>
            </div>
          </div>
