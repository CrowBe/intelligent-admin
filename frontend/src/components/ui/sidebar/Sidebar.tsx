...
export function SidebarRail({ className, ...props }: SidebarRailProps): React.ReactElement {
  const { toggleSidebar } = useSidebar();
...
export function SidebarInset({ className, ...props }: SidebarInsetProps): React.ReactElement {
  return (
    <main
...
export function SidebarHeader({ className, ...props }: SidebarHeaderProps): React.ReactElement {
  return (
    <div
...
export function SidebarFooter({ className, ...props }: SidebarFooterProps): React.ReactElement {
  return (
    <div
...
export function SidebarContent({ className, ...props }: SidebarContentProps): React.ReactElement {
  return (
    <div
...
export function SidebarGroup({ className, ...props }: SidebarGroupProps): React.ReactElement {
  return (
    <div
...
export function SidebarMenu({ className, ...props }: SidebarMenuProps): React.ReactElement {
  return (
    <ul
...
export function SidebarMenuItem({ className, ...props }: SidebarMenuItemProps): React.ReactElement {
  return (
    <li
...
export function SidebarMenuSub({ className, ...props }: SidebarMenuSubProps): React.ReactElement {
  return (
    <ul
