...
const SelectGroup = ({ ...props }: SelectGroupProps): React.ReactElement => {
  return <SelectPrimitive.Group data-slot="select-group" {...props} />;
};

export type SelectValueProps = React.ComponentProps<typeof SelectPrimitive.Value>;

const SelectValue = ({ ...props }: SelectValueProps): React.ReactElement => {
...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, size = "default", children, ...props }, ref): React.ReactElement => {
  return (
...
export interface SelectScrollButtonProps extends React.ComponentProps<typeof SelectPrimitive.ScrollUpButton> {
  className?: string;
}
