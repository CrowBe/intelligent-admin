  ...
  render: () => (
    <Breadcrumb>
      <BreadcrumbList>
        ...
        <BreadcrumbSeparator />
        <BreadcrumbItem>
          <BreadcrumbLink href="/products" className="flex items-center gap-1.5">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
...
export const LongText: Story = {
  render: () => (
    <Breadcrumb className="max-w-[600px]">
      <BreadcrumbList>
        <BreadcrumbItem>
          <BreadcrumbLink href="/">Home</BreadcrumbLink>
        </BreadcrumbItem>
        ...
        <BreadcrumbItem>
          <BreadcrumbPage>
            Very Long Current Page Name That Demonstrates Text Wrapping
          </BreadcrumbPage>
        </BreadcrumbItem>
      </BreadcrumbList>
    </Breadcrumb>
