    ...
    <div className='min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-card shadow-lg rounded-lg p-8 space-y-8'>
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              ...
              <ul className='list-disc pl-6 space-y-2'>
                <li>
                  <strong>Account Information:</strong> Name, email address, business information
                </li>
                <li>
                  <strong>Communication Data:</strong> Email content and metadata (with your consent)
                </li>
                <li>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-foreground mb-4'>3. Email Data Processing</h2>
            <div className='text-muted-foreground space-y-4'>
              <p>
              ...
              <p className='bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg'>
                <strong>Important:</strong> We only access emails when you explicitly grant permission. You can revoke
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              ...
              <ul className='list-disc pl-6 space-y-2'>
                <li>
                  <strong>Google Services:</strong> Gmail API, Google Authentication
                </li>
                <li>
                  <strong>Firebase:</strong> Authentication and push notifications
                </li>
                <li>
                  <strong>OpenAI:</strong> AI processing (data is not stored by OpenAI)
                </li>
              </ul>
              <p>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-foreground mb-4'>7. Australian Privacy Act Compliance</h2>
            <div className='text-muted-foreground space-y-4'>
              <p>
                As an Australian business, we comply with the Privacy Act 1988 and the Australian Privacy Principles
                (APPs). This includes ensuring your personal information is handled in accordance with Australian
                privacy law.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='text-muted-foreground'>
              ...
              <div className='mt-4 p-4 bg-muted rounded-lg'>
                <p>
                  <strong>Email:</strong> privacy@intelligent-admin.com
                </p>
                <p>
