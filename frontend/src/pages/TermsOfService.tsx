  ...
  return (
    <div className='min-h-screen bg-background py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='bg-card shadow-lg rounded-lg p-8 space-y-8'>
          <section>
            <h2 className='text-2xl font-semibold text-foreground mb-4'>1. Acceptance of Terms</h2>
            <div className='text-muted-foreground space-y-4'>
              <p>
                By accessing and using the Intelligent Assistant service ("Service"), you accept and agree to be bound
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>
                Intelligent Assistant is an AI-powered administrative assistant designed specifically for Australian
                trade businesses, providing:
              </p>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-foreground mb-4'>4. Email Access and Permissions</h2>
            <div className='text-muted-foreground space-y-4'>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>Our Service uses artificial intelligence to analyze and generate content. You acknowledge that:</p>
              <ul className='list-disc pl-6 space-y-2'>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>While we strive to provide continuous service, we do not guarantee that the Service will be:</p>
              <ul className='list-disc pl-6 space-y-2'>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>
                ...
                Privacy Policy, which forms part of these Terms of Service.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              ...
              <p>
                You retain ownership of your business data and content, but grant us necessary rights to provide the
                Service.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>
                To the maximum extent permitted by Australian law, we shall not be liable for any indirect, incidental,
                or consequential damages arising from your use of the Service.
              </p>
              <p className='bg-amber-50 dark:bg-amber-950/20 p-4 rounded-lg'>
                <strong>Important:</strong> This does not exclude or limit liability that cannot be excluded under
          ...
          <section>
            <h2 className='text-2xl font-semibold text-foreground mb-4'>12. Australian Consumer Law</h2>
            <div className='text-muted-foreground space-y-4'>
              <p>
                If you are a consumer under the Australian Consumer Law, you have guaranteed rights which cannot be
                excluded, restricted, or modified by this agreement.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='text-muted-foreground space-y-4'>
              <p>
                These Terms shall be interpreted and governed by the laws of Australia. Any disputes shall be resolved
                in the appropriate Australian courts.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className='text-muted-foreground'>
              ...
              <div className='mt-4 p-4 bg-muted rounded-lg'>
                <p>
                  <strong>Email:</strong> legal@intelligent-admin.com
                </p>
                <p>
          ...
          <section>
            ...
            <div className='text-muted-foreground'>
              <p>
                ...
                changes by posting the new terms on our website and updating the effective date.
              </p>
            </div>
          </section>
        </div>
